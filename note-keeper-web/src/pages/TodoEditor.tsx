        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-xs text-gray-500 mb-1">Deadline and recurrence start (required for repeating schedule).</p>
              <input
                type="datetime-local"
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mb-1">When to notify. Enables default channels from Settings.</p>
              <input
                type="datetime-local"
